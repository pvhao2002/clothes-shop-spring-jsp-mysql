            ...
            <div class="container-fluid px-4">
                ...
                <section id="content" class="container">
                    ...
                    <form:form method="post" modelAttribute="user" enctype="multipart/form-data">
                        ...
                        <hr>
                        <form:hidden path="userId" name="id"/>
                        ...
                        <form:input type="password" path="password" placeholder="Nhập mật khẩu" name="password"
                                    required="required"/>
                        ...
                        <form:input type="tel" path="phone" placeholder="Nhập số điện thoại" name="phone"/>

                        <label><b>Email</b></label>
                        <form:input type="email" path="email" placeholder="Nhập email" name="email"/>

                        <label><b>Địa chỉ</b></label>
                        <form:input type="text" path="address" placeholder="Nhập địa chỉ" name="address"/>
